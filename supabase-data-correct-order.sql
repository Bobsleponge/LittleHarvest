-- Supabase Data Migration Script - Correct Order
-- Run this AFTER running supabase-schema-only.sql

-- Step 1: Insert Users first (required for foreign keys)
...
-- Step 11: Insert Cart (now that User exists)
...
-- Step 13: Insert SettingsHistory
