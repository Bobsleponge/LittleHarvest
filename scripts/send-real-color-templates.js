/**
 * Generate 10 different email template designs using ACTUAL UI settings from the database
 * This script fetches the real colors from your admin UI settings
 */
  ...
  return `
    ...
    <head>
      ...
      <style>
        ...
        .footer { background: #f8fafc; padding: 30px; text-align: center; color: ${colors.muted}; }
      </style>
    </head>
    <body>
      <div class="container">
  ...
  return `
    ...
    <head>
      ...
      <style>
        ...
        .footer { text-align: center; margin-top: 20px; color: ${colors.muted}; }
      </style>
    </head>
    <body>
      <div class="container">
  ...
  return `
    ...
    <head>
      ...
      <style>
        ...
        .intro { font-size: 18px; line-height: 1.6; margin-bottom: 30px; color: ${colors.text}; }
        ...
        .footer { background: #f8f9fa; padding: 20px; text-align: center; color: ${colors.muted}; font-size: 14px; }
      </style>
    </head>
    <body>
      <div class="container">
  ...
  return `
    ...
    <head>
      ...
      <style>
        ...
        .welcome-text { font-size: 16px; line-height: 1.6; margin-bottom: 30px; color: ${colors.text}; }
        ...
        .footer { background: #f8fafc; padding: 20px; text-align: center; color: ${colors.muted}; }
      </style>
    </head>
    <body>
      <div class="container">
  ...
  return `
    ...
    <head>
      ...
      <style>
        ...
        .header p { margin: 10px 0 0 0; color: ${colors.muted}; font-size: 14px; }
        .content { padding: 40px; }
        .welcome-text { font-size: 16px; line-height: 1.6; color: ${colors.text}; margin-bottom: 40px; }
        ...
        .feature p { margin: 0; font-size: 14px; color: ${colors.muted}; }
        ...
        .footer { background: #f9fafb; padding: 30px 40px; text-align: center; color: ${colors.muted}; font-size: 12px; }
      </style>
    </head>
    <body>
      <div class="container">
  ...
  return `
    ...
    <head>
      ...
      <style>
        ...
        .footer { background: #f8fafc; padding: 25px; text-align: center; color: ${colors.muted}; }
      </style>
    </head>
    <body>
      <div class="container">
  ...
  return `
    ...
    <head>
      ...
      <style>
        ...
        .content { padding: 40px; }
        .intro { font-size: 16px; line-height: 1.6; color: ${colors.text}; margin-bottom: 30px; }
        ...
        .benefit-content p { margin: 0; color: ${colors.muted}; font-size: 14px; }
        .cta { text-align: center; margin: 40px 0; }
        .cta a { background: ${colors.primary}; color: white; padding: 14px 28px; text-decoration: none; border-radius: 6px; font-weight: 600; }
        .footer { background: #f8f9fa; padding: 25px 40px; text-align: center; color: ${colors.muted}; font-size: 14px; border-top: 1px solid #e9ecef; }
      </style>
    </head>
    <body>
      <div class="container">
...
async function sendAllTemplatesWithRealColors() {
  console.log('📧 Sending 10 email templates with ACTUAL UI colors from your admin dashboard...\n')
  ...
  for (let i = 0; i < templates.length; i++) {
    ...
    try {
      ...
      await transporter.sendMail({
        ...
        to: customerEmail,
        subject: `${template.name} - Welcome to Little Harvest (Real Colors)`,
        html: html,
        text: `Welcome to Little Harvest! This is ${template.name} using your actual UI colors.`
      })
  ...
  console.log('🎉 All 10 email templates sent with your ACTUAL UI colors!')
  console.log('📬 Check your inbox to see templates using your real color scheme!')
...
sendAllTemplatesWithRealColors()
