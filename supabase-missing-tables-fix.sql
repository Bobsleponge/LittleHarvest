...
-- Step 3: Create missing OrderItem table
...
-- Step 4: Create missing Inventory table
...
-- Step 5: Create missing Address table
...
-- Step 6: Create missing CartItem table
...
-- Step 7: Create missing SecurityEvent table
...
-- Step 8: Update existing tables to use UUID with auto-generation
-- Note: This will only work if the tables are empty or we handle existing data carefully

-- Update User table
ALTER TABLE "User" ALTER COLUMN id SET DEFAULT uuid_generate_v4();
ALTER TABLE "User" ALTER COLUMN id TYPE UUID USING id::UUID;

-- Update AgeGroup table
ALTER TABLE "AgeGroup" ALTER COLUMN id SET DEFAULT uuid_generate_v4();
ALTER TABLE "AgeGroup" ALTER COLUMN id TYPE UUID USING id::UUID;

-- Update Texture table
ALTER TABLE "Texture" ALTER COLUMN id SET DEFAULT uuid_generate_v4();
ALTER TABLE "Texture" ALTER COLUMN id TYPE UUID USING id::UUID;

-- Update PortionSize table
ALTER TABLE "PortionSize" ALTER COLUMN id SET DEFAULT uuid_generate_v4();
ALTER TABLE "PortionSize" ALTER COLUMN id TYPE UUID USING id::UUID;
...
ALTER TABLE "Product" ALTER COLUMN "ageGroupId" TYPE UUID USING "ageGroupId"::UUID;
ALTER TABLE "Product" ALTER COLUMN "textureId" TYPE UUID USING "textureId"::UUID;

-- Update Price table
ALTER TABLE "Price" ALTER COLUMN id SET DEFAULT uuid_generate_v4();
ALTER TABLE "Price" ALTER COLUMN id TYPE UUID USING id::UUID;
ALTER TABLE "Price" ALTER COLUMN "productId" TYPE UUID USING "productId"::UUID;
ALTER TABLE "Price" ALTER COLUMN "portionSizeId" TYPE UUID USING "portionSizeId"::UUID;

-- Update Package table
ALTER TABLE "Package" ALTER COLUMN id SET DEFAULT uuid_generate_v4();
ALTER TABLE "Package" ALTER COLUMN id TYPE UUID USING id::UUID;

-- Update PackageItem table
ALTER TABLE "PackageItem" ALTER COLUMN id SET DEFAULT uuid_generate_v4();
ALTER TABLE "PackageItem" ALTER COLUMN id TYPE UUID USING id::UUID;
ALTER TABLE "PackageItem" ALTER COLUMN "packageId" TYPE UUID USING "packageId"::UUID;
ALTER TABLE "PackageItem" ALTER COLUMN "productId" TYPE UUID USING "productId"::UUID;
ALTER TABLE "PackageItem" ALTER COLUMN "portionSizeId" TYPE UUID USING "portionSizeId"::UUID;
...
-- Update ChildProfile table
ALTER TABLE "ChildProfile" ALTER COLUMN id SET DEFAULT uuid_generate_v4();
ALTER TABLE "ChildProfile" ALTER COLUMN id TYPE UUID USING id::UUID;
ALTER TABLE "ChildProfile" ALTER COLUMN "profileId" TYPE UUID USING "profileId"::UUID;

-- Update Cart table
ALTER TABLE "Cart" ALTER COLUMN id SET DEFAULT uuid_generate_v4();
ALTER TABLE "Cart" ALTER COLUMN id TYPE UUID USING id::UUID;
ALTER TABLE "Cart" ALTER COLUMN "userId" TYPE UUID USING "userId"::UUID;

-- Update StoreSettings table
ALTER TABLE "StoreSettings" ALTER COLUMN id SET DEFAULT uuid_generate_v4();
ALTER TABLE "StoreSettings" ALTER COLUMN id TYPE UUID USING id::UUID;

-- Update SettingsHistory table
ALTER TABLE "SettingsHistory" ALTER COLUMN id SET DEFAULT uuid_generate_v4();
ALTER TABLE "SettingsHistory" ALTER COLUMN id TYPE UUID USING id::UUID;
...
-- Step 10: Enable Row Level Security (RLS) on sensitive tables
...
-- CartItems: Users can only access items in their own cart
...
-- ChildProfile: Users can only access child profiles linked to their profile
...
-- Address: Users can only access addresses linked to their profile
...
-- SecurityEvent: Only admins can view security events
...
SELECT 'Missing tables created and UUID generation enabled successfully!' as status;
