' Tiny Tastes - VBScript Desktop Launcher
...
If Not objFSO.FileExists(strPath & "\package.json") Then
    MsgBox "ERROR: This launcher must be in the Tiny Tastes project folder" & vbCrLf & _
           "Please move this file to your project root directory", vbCritical, "Tiny Tastes Launcher"
    WScript.Quit 1
End If
...
If strNodeVersion <> 0 Then
    MsgBox "ERROR: Node.js is not installed" & vbCrLf & _
           "Please install Node.js from https://nodejs.org/", vbCritical, "Tiny Tastes Launcher"
    WScript.Quit 1
End If
...
If strNpmVersion <> 0 Then
    MsgBox "ERROR: npm is not available", vbCritical, "Tiny Tastes Launcher"
    WScript.Quit 1
End If

' Show startup message
MsgBox "Starting Tiny Tastes Application..." & vbCrLf & vbCrLf & _
       "This may take a moment on first run." & vbCrLf & vbCrLf & _
       "The application will open in your default browser.", vbInformation, "Tiny Tastes Launcher"
...
MsgBox "Tiny Tastes has been stopped.", vbInformation, "Tiny Tastes Launcher"
